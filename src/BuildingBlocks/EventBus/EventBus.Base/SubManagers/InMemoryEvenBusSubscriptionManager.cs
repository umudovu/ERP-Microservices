...
{
    public class InMemoryEvenBusSubscriptionManager : IEventBusSubscriptionManager
    {
        ...
        public InMemoryEvenBusSubscriptionManager(Func<string, string> eventNameGetter)
        {
